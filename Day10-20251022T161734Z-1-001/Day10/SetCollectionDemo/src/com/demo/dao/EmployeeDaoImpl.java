...
//	    };
//
//	    // Create TreeSet with comparator — automatically sorted
//	    Set<Employee> tset = new TreeSet<>(c);
//
//	    // Add all employees from original set to TreeSet
//	    for(Employee e : eset) {
//	        tset.add(e);
//	    }
//
//	    // Convert TreeSet back to List (if you want to return a list)
//	    List<Employee> elist = new ArrayList<>(tset);
//
//	    return elist;
//	}
//
